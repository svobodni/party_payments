class Donation < ActiveRecord::Base
  ...
  def agreement_pdf
    document = Prawn::Document.new(:page_size => 'A4') do |pdf|
      ...
      pdf.text("2. Dárce poskytne obdarovanému na jeho činnost, finanční dar v hodnotě #{number_to_currency(amount, t(:'pdf.currency.format'))}, tj. slovy #{} korun českých (dále jen dar). Dar bude obdarovanému splacen na jeho účet vedený u Fio bank č. ú.: 2700382803/2010  a Obdarovaný dar přijímá.")
